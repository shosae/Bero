...
BT_REGISTER_NODES(factory)
{
  ...
  factory.registerBuilder<bero_multi_floor_nav::GetMissionDataNode>("GetMissionData", builder_get_mission);  // NOLINT

  BT::NodeBuilder builder_wait_confirm =
    [](const std::string & name, const BT::NodeConfiguration & config) {
      return std::make_unique<bero_multi_floor_nav::WaitForConfirmationNode>(name, config);};
  factory.registerBuilder<bero_multi_floor_nav::WaitForConfirmationNode>("WaitForConfirmation", builder_wait_confirm);  // NOLINT
  ...
  factory.registerBuilder<bero_multi_floor_nav::PressButtonNode>("PressButton", builder_press_button);  // NOLINT

  BT::NodeBuilder builder_door_monitor =
    [](const std::string & name, const BT::NodeConfiguration & config) {
      return std::make_unique<bero_multi_floor_nav::WaitForDoorOpenNode>(name, config);};
  factory.registerBuilder<bero_multi_floor_nav::WaitForDoorOpenNode>("WaitForDoorOpen", builder_door_monitor);  // NOLINT
  ...
  factory.registerBuilder<bero_multi_floor_nav::FloorEstimationNode>("FloorEstimation", builder_floor_estimation);  // NOLINT

  BT::NodeBuilder builder_azcalibrator =
    [](const std::string & name, const BT::NodeConfiguration & config) {
      return std::make_unique<bero_multi_floor_nav::AzOffsetCalibratorNode>(name, config);};
  factory.registerBuilder<bero_multi_floor_nav::AzOffsetCalibratorNode>("AzOffsetCalibrator", builder_azcalibrator);  // NOLINT
  // *INDENT-ON*
}
